<!--
 * @Author: GZF
 * @Date: 2025-01-19 10:09:01
 * @Description: 时间统计 - 字数统计 - 图片统计 - 阅读时间
-->
...
<template>
  <div class="word">
    <p>
      <svg class="icon" height="16" p-id="18131" t="1724572866572" version="1.1"
      ...
      <span v-if="date">更新: {{ date.toLocaleString() }}</span>
      <svg class="icon" height="16" p-id="6125" t="1724571760788" version="1.1"
           viewBox="0 0 1024 1024" width="16" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      字数: {{ wordCount }} 字
      <svg class="icon" height="16" p-id="15031" t="1724572797268" version="1.1"
           viewBox="0 0 1060 1024" width="16" xmlns="http://www.w3.org/2000/svg">
        <path
